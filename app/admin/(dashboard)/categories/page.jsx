  ...
  return (
    <div>
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-gold-400/10 pb-6">
        <div>
          <h1 className="font-display text-3xl sm:text-4xl font-bold text-ink">
            Store <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-600 via-gold-500 to-gold-700">Categories</span>
          </h1>
          <p className="text-base text-ink/50 font-semibold mt-1">Organize your catalogue into fabric and kurta collections.</p>
        </div>
        <Link
      ...
      <div className="hidden overflow-x-auto rounded-[2rem] border border-gold-400/10 bg-white p-6 backdrop-blur-md shadow-soft sm:block md:p-8">
        {categories.length === 0 ? (
          <p className="py-12 text-center text-sm text-ink/45">No categories yet — create your first one.</p>
        ) : (
